...
taxcalcbench/
  ...
  run_case.ts         # Runs a single case through the engine, saves expected.json
  run_all.ts          # Regenerates expected.json for every case (bulk engine run)
  cases/
    01-single-w2-minimal/
      input.json      # Tax return inputs (forms + filing info)
      correct.json    # Ground truth computed by tax2025.ts
      expected.json   # Last engine output (generated by run_case.ts / run_benchmark.ts)
    02-single-w2-basic/
    ...
