...
function buildIRS1040Schedule3(fields: Schedule3Input): string {
...
class Schedule3MefNode extends MefNode {
  readonly pdfUrl = "https://www.irs.gov/pub/irs-pdf/f1040s3.pdf";
  build(pending: MefFormsPending): string {
    return buildIRS1040Schedule3(pending.schedule3 ?? {});
  }
}

export const schedule3 = new Schedule3MefNode();
