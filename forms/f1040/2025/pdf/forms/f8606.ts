...
const fields: ReadonlyArray<PdfFieldEntry> = [
  { kind: "text", domainKey: "nondeductible_contributions", pdfField: "topmostSubform[0].Page1[0].f1_03[0]" },
  { kind: "text", domainKey: "prior_basis", pdfField: "topmostSubform[0].Page1[0].f1_04[0]" },
  { kind: "text", domainKey: "year_end_ira_value", pdfField: "topmostSubform[0].Page1[0].f1_09[0]" },
  { kind: "text", domainKey: "traditional_distributions", pdfField: "topmostSubform[0].Page1[0].f1_10[0]" },
  { kind: "text", domainKey: "roth_conversion", pdfField: "topmostSubform[0].Page1[0].f1_11[0]" },
  { kind: "text", domainKey: "roth_distribution", pdfField: "topmostSubform[0].Page1[0].f1_22[0]" },
  { kind: "text", domainKey: "roth_basis_contributions", pdfField: "topmostSubform[0].Page1[0].f1_01[0]" },
  { kind: "text", domainKey: "roth_basis_conversions", pdfField: "topmostSubform[0].Page1[0].f1_02[0]" },
];
