...
export const F8941_RULES: readonly RuleDef[] = [
  ...
  rule(
    ...
    "reject",
    "incorrect_data",
    ifThen(gt("SmllEmplrHIPFTEEmplForTaxYrCnt", 24), all(
      isZero("AvgAnnualWagesPdForTxYrAmt"),
      isZero("HIPPaidForEmplEmployedForCrAmt"),
      isZero("SmllEmplrHIPPotentiallyPaidAmt"),
      isZero("SmllEmplrEligibleHIPPaidAmt"),
      isZero("SmllEmplrEligHIPTimesPctAmt"),
      isZero("SmllEmplrHIPFTECreditAmt"),
      isZero("AnnualWgPdLessThanSpecifiedAmt"),
      isZero("TotStPremSbsdyPdOrCrForHIPAmt"),
  ...
  rule(
    ...
    "reject",
    "incorrect_data",
    ifThen(gt("AvgAnnualWagesPdForTxYrAmt", 67000), all(
      isZero("HIPPaidForEmplEmployedForCrAmt"),
      isZero("SmllEmplrHIPPotentiallyPaidAmt"),
      isZero("SmllEmplrEligibleHIPPaidAmt"),
      isZero("SmllEmplrEligHIPTimesPctAmt"),
      ...
      isZero("AnnualWgPdLessThanSpecifiedAmt"),
      isZero("TotStPremSbsdyPdOrCrForHIPAmt"),
      isZero("HIPPdLessTotStPremOrCrAmt"),
      isZero("SmallerAnnualWgPdOrHIPPdAmt"),
    )),
